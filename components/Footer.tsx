      ...
      <div className="flex mt-20 md:flex-row flex-col justify-between items-center ">
        ...
        <div className="flex items-center md:gap-3 gap-6">
            {socialMedia.map((item)=>(
                <div key={item.id} className="flex lg:mt-20 mt-2 md:mt-0 w-10 h-10 cursor-pointer justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 dark:bg-opacity-75 bg-violet-600 dark:bg-black-200 rounded-e-lg border border-black-300 dark:hover:bg-black-100 hover:bg-violet-700">
